...
# Este archivo ha sido congelado. No se realizarán más cambios a menos que se solicite explícitamente.
...
def main():
    ...
    parser.add_argument("--excel", type=str, default="/Users/didac/Downloads/StoryMac/DashBTracker/PruebasCdM/Tchart_V06.xlsm", help="Ruta al archivo Excel (por defecto: /Users/didac/Downloads/StoryMac/DashBTracker/PruebasCdM/Tchart_V06.xlsm)")
    parser.add_argument("--historic-sheet", type=str, default="FrmBB_2", help="Nombre de la hoja de datos históricos (por defecto: FrmBB_2)")
    parser.add_argument("--kpi-sheet", type=str, default="FrmBB_3", help="Nombre de la hoja de datos KPI (por defecto: FrmBB_3)")
    ...
    def extract_and_format_data(excel_path, historic_sheet, kpi_sheet, debug=False):
        ...
        # Asegurar que data['kpiData'] sea una lista incluso si ocurre un error
        if 'kpiData' not in data or data['kpiData'] is None:
            data['kpiData'] = []
