...
def create_tree_view(data):
    """
    Crea la vista de árbol de costes para datos tipo T (versión directa y funcional).
    """
    ...
    for row in tree_data:
        ...
        # Aquí puedes usar la función create_treemap_figure si lo deseas, o el método antiguo si lo prefieres
